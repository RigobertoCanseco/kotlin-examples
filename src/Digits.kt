...
fun power(p:Double): MutableSet<Int>{
    ...
    (0 until 10).forEach{i -> (0 until 10).forEach { j -> (0 until 10).forEach { k -> (0 until 10).forEach { l -> (0 until 10).forEach { m -> (0 until 10).forEach { n -> (0 until 10).forEach { o ->
        var a = "$i$j$k$l$m$n$o".toInt()
